...
Concepts:   1. Different torch functions for generating tensors
            2. what are int32, int64
            3. Create random tensors
            4. How to reproduce the same random tensor you
            have created
"""
...
# high is exclusive, meaning never peaked
